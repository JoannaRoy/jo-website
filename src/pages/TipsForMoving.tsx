...
const previewImgUrl = (name: string) =>
  new URL(`../blog_data/preview_images/${name}`, import.meta.url).href;
...
function Card({ title, className = "", children }: CardProps) {
  return (
    <section
      className={[
        "rounded-3xl p-5 md:p-6 shadow-lg border border-white/60",
        "bg-white/90 backdrop-blur-md",
        className,
      ].join(" ")}
    >
      {title ? <h2 className="text-lg md:text-xl font-bold text-gray-900 m-0">{title}</h2> : null}
      <div className={title ? "mt-3 text-gray-800" : "text-gray-800"}>{children}</div>
    </section>
  );
}
...
export default function TipsForMoving() {
  return (
    <PageGrid columns={1}>
      <div className="relative overflow-hidden p-4 md:p-8 mx-auto w-full h-full font-body">
        <ScribbleBackground
        ...
        <div className="relative z-10 p-5 md:p-8">
          <div className="text-left mx-auto mb-6 md:mb-8 w-[90vw]">
            ...
            <p className="mt-3 text-gray-700">
              ...
              advice/tips (for others) about moving to a new country. Talking to people who moved abroad has been immensely helpful for me, so this is my
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-5 md:gap-6">
            ...
            >
              <div className="flex flex-col gap-3">
                <Collapsible summary="Germans have a reputation for being a bit cold and direct — and while I sometimes notice this, I also appreciate how this makes the nice conversations more genuine">
                  <p className="m-0">
                    Coming from Canada, which is notoriously polite and apologetic (sorry) -- so
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                <img
                  src={previewImgUrl("movin.jpg")}
                  alt="Moving"
                  className="w-full h-32 md:h-36 object-cover rounded-2xl shadow-sm"
                />
                <img
                  src={previewImgUrl("hello.jpeg")}
                  alt="Hello"
                  className="w-full h-32 md:h-36 object-cover rounded-2xl shadow-sm"
                />
                <img
                  src={previewImgUrl("brezn.jpeg")}
                  alt="Brezn"
                  className="w-full h-32 md:h-36 object-cover rounded-2xl shadow-sm col-span-2"
                />
              </div>
            </Card>
              ...
              <div className="flex flex-col gap-3">
                <Collapsible summary="It forces you to become more comfortable in unfamiliar environments">
                  <p className="m-0">
                    ...
                    they are less familiar -- small wins feel like bigger accomplishments. And yet,
                    somehow you will figure out how to navigate it -- this can do wonders for your
                    self efficacy, resilience, and general ability to take on future challenges.
                  </p>
                </Collapsible>

                <Collapsible summary="Starting over / building from the ground up">
                  <p className="m-0">
                    When you move, you start from a blank slate, for better or for worse. This can
                    be true for everything from your personality to accolades you'd accrued prior
                    to moving. You/your friends probably see you as a certain 'type' of person with
                    certain personality traits -- it can be surprising to see which of those stick,
                    and which new ones emerge, when you're in a completely new environment.
                    Similarly, I remember feeling like I'd worked so hard to get this fancy
                    engineering degree from a fancy program in Canada, but it felt like far fewer
                ...
                <Collapsible summary="Getting to know people from all over the world">
                  <p className="m-0">
                    ...
                    people with all sorts of interests and from all sorts of countries. My book
                    ...
                    world through the people I've met -- and its always a good reminder that your
            ...
            >
              <div className="flex flex-col gap-3">
                <Collapsible summary="Feeling old friendships fade">
                  <p className="m-0">
                    There is the excitement new friendships you are building, but they’re not as
                    ...
                    having so little real connection to other people. I missed my friends and how
                    close we used to be and how comfortable we were around each other. Its hard to
                    ...
                    but miss so much of the crux of what the friendship used to be. Life feels like
                    its happening really fast - it can’t be summarized like a highlight reel in a
                    phone call.
                  </p>
                </Collapsible>
                ...
                <Collapsible summary="Missing family">
                  <p className="m-0">
                    ...
                    special as ever before, and that I’ll never ever take my family or friends for
                ...
                <Collapsible summary="Having grown up differently than those around me">
                  <p className="m-0">
                    When I'm in Toronto, its more likely that the people I'm around/talking to share
                    ...
                    moving, which they would be unfamiliar with). That said, I often find myself
                ...
                <Collapsible summary="The language barrier">
                  <p className="m-0">
                    ...
                    but its surprising how much this guilt builds up and affects other parts of
                    life (everything just feels a bit harder) -- ranging from relatively small (I
                    have put off doing laundry only because I'm afraid of not understanding the
                    ...
                    a translator). Beyond that, it took some time to adjust to not being able to
                    ...
                    about, or to try to understand bits of what they’re saying. I can never get
                    bored while walking home, since I always have street signs to look at and quiz
                    myself on which ones I understand.
                  </p>
                </Collapsible>

                <Collapsible summary="Just generally feeling more alone in the new place">
                  <p className="m-0">
                    To be clear, this is not always a bad thing. I like to have alone time where I
                    can ponder new things while exploring new places and activities, and it can be
                    nice to have a fresh start. That said, its destabilizing to be away from the
                    ...
                    but sometimes it can make you miss the comforts of people around you who <em>know</em> you and get you without you having to explain yourself. The people
            ...
            <Card
              title="Things That Helped Me Adjust 🫡"
              className="md:col-span-6"
            >
              <div className="flex flex-col gap-3">
                <Collapsible summary="BINJO">
                  <p className="my-2">
                    I started putting a BINJO card on my website, with a (somewhat
                    random/disjointed) set of goals for the year. Every time I made progress towards
                    one of them, I would update the site -- and when I got all five goals in a
                    row/column/diagonal (yes, you guessed it -- BINJO!), I treated myself to a prize
                  ...
                  <ol className="mt-3 list-decimal pl-5 space-y-3">
                    ...
                    <li>
                      <p className="m-0">
                        <strong>Explore</strong> the items often helped me explore my new country --
                        I took two day trips per month in 2025, a friend took me clubbing for my first
                        time (its big over here haha), partook in a triathlon organized by a colleague,
                    ...
                    <li>
                      <p className="m-0">
                        <strong>Rebuild routines</strong> When you move, many of your
                        routines/regular structures and places you rely on are no longer there. You
                        have to readjust -- find your favourite spots (grocery stores, running routes,
                ...
                <Collapsible summary="Book club">
                  <p className="my-2">
                    I&apos;d wanted to join a book club for some time prior to moving, but didn&apos;t have
                    time for one because of school and other commitments (I also just didn&apos;t know
                    of any happening amongst people I knew). When I moved to Munich, I tried to join
                  ...
                  <p className="my-2">
                    ...
                    mine started a badminton club, or you could start a hiking club/running
                    club/etc etc etc. It doesn&apos;t really matter what the group is doing, as long as
                    its something that interests you. As long as you can find a platform to share
                ...
                <Collapsible summary="Connecting with other people who moved abroad">
                  ...
                  <p className="my-2">
                    ...
                    experiences -- talking to others who have navigated them previously can be
                ...
                <Collapsible summary="Invite friends and family to visit">
                  <p className="my-2">
                    When people come to visit you in your new location, you will see how much
                    progress you&apos;ve made. Their confusion with transit, directions, language,
                    culture/custom, etc will likely all remind you of yourself when you first
                    arrived. But you will no longer be confused -- instead, you&apos;ll be able to
                    explain things and show them around :) It&apos;s easy to miss that kind of progress
                ...
                <Collapsible summary="Choose your job (or program) wisely">
                  <p className="my-2">
                    ...
                    friends in Germany -- it&apos;s been a chance to work with smart, nice, driven people
            ...
            >
              <p className="my-2">
                Being in a new country can be a bit isolating at times, so going out of your way to
                do things that will help you connect with people is so worthwhile. Even if you don't
                do a BINJO, you can (and should) try new things -- the best part of being in a new
                country is that people are unlikely to recognize you if you totally embarass
                yourself in the process :D
              </p>
              <p className="my-2">
                I have responsibilities now that I did not have before, and I have overcome things
                that I wasn’t sure I’d be able to on my own. I sometimes think about how proud
                little Jo would be of me. I used to get so homesick, summer camp away from my
                parents was so terrifying — but now here I am on a different continent alone, and
