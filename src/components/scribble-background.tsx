...
export function ScribbleBackground({
  ...
  const defaultStrokeColours = ["#6d5cf6", "#d7255f", "#0b8896"];
  const getStrokeColour = (idx: number) =>
    strokeColours?.[idx] ?? defaultStrokeColours[idx] ?? defaultStrokeColours[0];
